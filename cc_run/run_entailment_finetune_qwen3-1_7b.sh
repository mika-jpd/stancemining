...
python -m experiments.scripts.train_models finetune.task=claim-entailment-4way data.dataset=[stanceosaurus,kirk] finetune.model_name=Qwen/Qwen3-1.7B finetune.batch_size=64 finetune.grad_accum_steps=2 finetune.classification_method=head finetune.num_epochs=3 finetune.attn_implementation=null
