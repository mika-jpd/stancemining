...
python -m experiments.scripts.train_model finetune.task=claim-entailment-4way data.dataset=[stanceosaurus,conspiracies] finetune.model_name=Qwen/Qwen3-4B finetune.batch_size=32 finetune.grad_accum_steps=2 finetune.classification_method=head finetune.num_epochs=3 finetune.lora_r=64 finetune.lora_alpha=128 finetune.attn_implementation=null
